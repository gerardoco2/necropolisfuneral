...
const SingleBlogPage = ({ params }: { params: { id: number } }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://graph.instagram.com/${post_id}?fields=id,media_type,media_url,caption&access_token=IGQWRQeUdqcGhRZADZAQWFNENGh6d1Y2UTZAkdzF4OTJVdGpBRV9SQ0c3MmgyM0l4M2h3cm0wcmlWYmJEMGljT1dNMXFLbEZAOVmFqd2lyODJ2ZAWhuaFBObFV1MnRpRnA5Vkk4clJvUGx5aFZAqaUdwNkZATU0dxUXZA3WGcZD`,
      )
      .then((resp) => {
        setPost(resp.data);
